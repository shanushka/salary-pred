...
c4 = pd.read_csv('RenewableEngineer.csv')
c5 = pd.read_csv('SystemEmbeddedEngineer.csv')
...
c4["JobType"] = "Renewable Engineer"
c5["JobType"] = "System Embedded Engineer"

# df = pd.concat([df_2, df_1])

df_c = pd.concat([c1, c2, c3, c4, c5])
...
df = pd.concat([df_f, df_s, df_b, df_c, df_e, df_h])
